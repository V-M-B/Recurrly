...
/** Evaluate password strength on a 0-3 scale */
function getPasswordStrength(pw: string): { score: number; label: string; color: string } {
    ...
    const levels: Record<number, { label: string; color: string }> = {
        ...
        1: { label: 'Fair', color: '#ea7a53' },
        2: { label: 'Good', color: '#eab308' },
        3: { label: 'Strong', color: '#16a34a' },
    };
                        ...
                        <View className="auth-content">
                            ...
                            <View className="auth-card">
                                <View className="auth-form">
                                    ...
                                    >
                                        {isLoading ? (
                                            <View className="auth-loading-row">
                                                <ActivityIndicator size="small" color="#081126" />
                                                <Text className="auth-button-text">Verifying…</Text>
                                            </View>
                                        ) : (
                                ...
                                <View className="auth-field">
                                    ...
                                    {password.length > 0 && (
                                        <View className="gap-1">
                                            <View className="auth-strength-bar">
                                                <View
